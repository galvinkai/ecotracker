...
def check_fly_auth():
    ...
    success, output = run_command("flyctl auth whoami", "Checking Fly.io authentication")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Deploy EcoTracker with QR Code functionality to Fly.io")
    parser.add_argument("--skip-checks", action="store_true", help="Skip dependency checks")
    parser.add_argument("--test-only", action="store_true", help="Only test QR endpoints, don't deploy")
